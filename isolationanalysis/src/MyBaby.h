...
class MyBaby {
 ...
 protected: 
  ...
  vector<float> *lep_relIso040EAstudy_;
  TBranch *lep_relIso040EAstudy_branch;
  bool     lep_relIso040EAstudy_isLoaded;
  ...
  vector<float> *lep_relIso005EAstudyv2_;
  TBranch *lep_relIso005EAstudyv2_branch;
  bool     lep_relIso005EAstudyv2_isLoaded;
  vector<float> *lep_relIso010EAstudyv2_;
  TBranch *lep_relIso010EAstudyv2_branch;
  bool     lep_relIso010EAstudyv2_isLoaded;
  vector<float> *lep_relIso015EAstudyv2_;
  TBranch *lep_relIso015EAstudyv2_branch;
  bool     lep_relIso015EAstudyv2_isLoaded;
  vector<float> *lep_relIso020EAstudyv2_;
  TBranch *lep_relIso020EAstudyv2_branch;
  bool     lep_relIso020EAstudyv2_isLoaded;
  vector<float> *lep_relIso025EAstudyv2_;
  TBranch *lep_relIso025EAstudyv2_branch;
  bool     lep_relIso025EAstudyv2_isLoaded;
  vector<float> *lep_relIso030EAstudyv2_;
  TBranch *lep_relIso030EAstudyv2_branch;
  bool     lep_relIso030EAstudyv2_isLoaded;
  vector<float> *lep_relIso035EAstudyv2_;
  TBranch *lep_relIso035EAstudyv2_branch;
  bool     lep_relIso035EAstudyv2_isLoaded;
  vector<float> *lep_relIso040EAstudyv2_;
  TBranch *lep_relIso040EAstudyv2_branch;
  bool     lep_relIso040EAstudyv2_isLoaded;
  vector<float> *lep_relIso045EAstudyv2_;
  TBranch *lep_relIso045EAstudyv2_branch;
  bool     lep_relIso045EAstudyv2_isLoaded;
  vector<float> *lep_relIso050EAstudyv2_;
  TBranch *lep_relIso050EAstudyv2_branch;
  bool     lep_relIso050EAstudyv2_isLoaded;
  ...
  int      evt_nvtx_;
  TBranch *evt_nvtx_branch;
  bool     evt_nvtx_isLoaded;
  float    evt_scale1fb_;
...
void LoadAllBranches(); 
  ...
  const vector<float> &lep_relIso040EAstudy();
  const vector<float> &lep_relIso045EAstudy();
  const vector<float> &lep_relIso050EAstudy();
  const vector<float> &lep_relIso005EAstudyv2();
  const vector<float> &lep_relIso010EAstudyv2();
  const vector<float> &lep_relIso015EAstudyv2();
  const vector<float> &lep_relIso020EAstudyv2();
  const vector<float> &lep_relIso025EAstudyv2();
  const vector<float> &lep_relIso030EAstudyv2();
  const vector<float> &lep_relIso035EAstudyv2();
  const vector<float> &lep_relIso040EAstudyv2();
  const vector<float> &lep_relIso045EAstudyv2();
  const vector<float> &lep_relIso050EAstudyv2();
